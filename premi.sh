...
data_ip="https://raw.githubusercontent.com/DEFFOFFICIAL/install/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/DEFFOFFICIAL"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
...
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}DEFFOFFICIAL ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/DEFFOFFICIAL/install/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/DEFFOFFICIAL/install/main/ip"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/@DEFFOFFICIAL"}]]}' 
...
wget -q https://raw.githubusercontent.com/DEFFOFFICIAL/install/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
